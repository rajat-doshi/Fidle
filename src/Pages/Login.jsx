                                    ...
                                    <div className="col-lg-6">
                                        <div className="p-5">
                                            ...
                                            <form className="user" onSubmit={e=>e.preventDefault()}>
                                                ...
                                                <div className="form-group">
                                                    <input type="file" onChange={this.onChange} className="form-control form-control-user"
                                                           id="exampleInputPassword" placeholder="File Upload"/>
                                                </div>
                                                <div className="form-group">
                                                ...
                                                <div className="form-group">
                                                    <div className="custom-control custom-checkbox small">
                                                        <input type="file" className="custom-control-input"
                                                               id="customCheck"/>
                                                            <label className="custom-control-label"
                                                                   htmlFor="customCheck">Remember
                                                                Me</label>
